...
public class BookServiceImpl implements BookService {
    ...
    @Transactional
    @Override
    public BookDto update(long bookId, String title, long authorId, List<Long> genresIds) {
        return save(bookId, title, authorId, genresIds);
    }
    ...
    private BookDto save(long bookId, String title, long authorId, List<Long> genresIds) {
        ...
        var book = bookRepository.saveBook(new Book(bookId, title, author, genres));
