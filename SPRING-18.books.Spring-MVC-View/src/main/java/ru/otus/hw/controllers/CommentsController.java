...
public class CommentsController {
    ...
    public String listPage(@PathVariable("bookId") long bookId, Model model) {
        ...
        if (commentOpt.isEmpty()) {
            return "redirect:/api/v1/book/%d/comment/page-add".formatted(bookId);
        }
    ...
    @GetMapping("/api/v1/book/{bookId}/comment/page-add")
    ...
    @GetMapping("/api/v1/book/{bookId}/comment/{commentId}/page-edit")
    ...
    @GetMapping("/api/v1/book/{bookId}/comment/{commentId}/page-delete")
    ...
    @PostMapping("/api/v1/book/{bookId}/comment/add")
    public String insertAction(@PathVariable("bookId") Long bookId, String description) {
        commentService.insert(bookId,description);
        return "redirect:/api/v1/book/%d/comment".formatted(bookId);
    }

    @PostMapping("/api/v1/book/{bookId}/comment/{commentId}/edit")
    ...
    @PostMapping("/api/v1/book/{bookId}/comment/{commentId}/delete")
