...
class CommentsControllerTest {
    ...
    void listPage() throws Exception {
        long bookId = 1;
        String url = BASE_URL + "/books/" + bookId + "/comments";
    ...
    void addPage() throws Exception {
        ...
        String url = BASE_URL + "/books/" + bookId + "/comments/add";
    ...
    void editPage() throws Exception {
        ...
        String url = BASE_URL + "/books/" + bookId + "/comments/" + commentId + "/edit";
        BookDto bookDto = new BookDto(bookId, "Title", new AuthorDto(0, "Author"),
                List.of(new GenreDto(0, "Genre")));
    ...
    void deletePage() throws Exception {
        ...
        long commentId = 1;
        String expect = "Comment 1";
        String url = BASE_URL + "/books/" + bookId + "/comments/" + commentId + "/delete";
        BookDto bookDto = new BookDto(bookId, "Title", new AuthorDto(0, "Author"),
                List.of(new GenreDto(0, "Genre")));
        CommentDto commentDto = new CommentDto(commentId, expect, bookDto);
