...
//    @WithMockUser(username = "admin", authorities = "ROLE_ADMIN")
    void listPage() throws Exception {
        ...
        var result = mockMvc.perform(get("/genres"))
...
//    @WithMockUser(username = "admin", authorities = "ROLE_ADMIN")
    void addPage() throws Exception {
        ...
        String content = mockMvc.perform(get("/genres/add"))
                .andExpect(status().isOk())
                .andReturn()
                .getResponse()
                .getContentAsString();
...
//    @WithMockUser(username = "admin", authorities = "ROLE_ADMIN")
    void editPage() throws Exception {
        ...
        String content = mockMvc.perform(get("/genres/" + id + "/edit"))
                .andExpect(status().isOk())
                .andReturn()
                .getResponse()
                .getContentAsString();
...
//    @WithMockUser(username = "admin", authorities = "ROLE_ADMIN")
    void deletePage() throws Exception {
        ...
        String content = mockMvc.perform(get("/genres/" + id + "/delete"))
                .andExpect(status().isOk())
                .andReturn()
                .getResponse()
                .getContentAsString();
...
//    @WithMockUser(username = "admin", authorities = "ROLE_ADMIN")
    void updateAction() throws Exception {
        ...
        // method for test
        mockMvc.perform(post("/genres/" + id + "/edit")
                        .with(csrf())
                        .contentType(MediaType.APPLICATION_FORM_URLENCODED)
                        .characterEncoding(StandardCharsets.UTF_8)
                        .param("id", String.valueOf(genreDto.getId()))
...
//    @WithMockUser(username = "admin", authorities = "ROLE_ADMIN")
    void deleteAction() throws Exception {
        ...
        // method for test
        mockMvc.perform(post("/genres/" + id + "/delete")
                        .with(csrf())
                        .contentType(MediaType.APPLICATION_FORM_URLENCODED)
                        .characterEncoding(StandardCharsets.UTF_8)
                        .param("id", String.valueOf(genreDto.getId()))
